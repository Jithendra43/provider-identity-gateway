...
import chit.tefca.ingress.dto.MessageDeliveryRequest;
...
@RestController
@RequestMapping(SecurityConstants.TEFCA_PREFIX + "/message-delivery")
...
public class MessageDeliveryController {
    ...
    @PostMapping
    public ResponseEntity<TefcaResponse> deliverMessage(
            @Valid @RequestBody MessageDeliveryRequest request,
        ...
        TefcaResponse response = orchestrator.processMessageDelivery(request, identity, hipaa);
